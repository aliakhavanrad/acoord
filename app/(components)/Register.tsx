...
export default function Register() {
  ...
  return (
    <div>
      <div className={styles.fullScreenContainer + ' ' + styles.blurBackground}></div>
                  ...
                  <div className={styles.row}>
                    ...
                    <div className={styles.colSm8}>
                      <input
                        ...
                        className={styles.formControl + (submitted && errors.name ? ' ' + styles.isInvalid : '')}
                      />
                  ...
                  <div className={styles.row}>
                    ...
                    <div className={styles.colSm8}>
                      <input
                        ...
                        onChange={handleChange}
                        className={styles.formControl + (submitted && errors.username ? ' ' + styles.isInvalid : '')}
                      />
                  ...
                  <div className={styles.row}>
                    ...
                    <div className={styles.colSm8}>
                      <input
                        ...
                        onChange={handleChange}
                        className={styles.formControl + (submitted && errors.password ? ' ' + styles.isInvalid : '')}
                      />
                  ...
                  <div className={styles.row}>
                    ...
                    <div className={styles.colSm8}>
                      <input
                        ...
                        onChange={handleChange}
                        className={styles.formControl + (submitted && errors.confirmPassword ? ' ' + styles.isInvalid : '')}
                      />
                  ...
                  <div className={styles.row}>
                    ...
                    <div className={styles.colSm8}>
                      <input
                        ...
                        onChange={handleChange}
                        className={styles.formControl + (submitted && errors.phoneNumber ? ' ' + styles.isInvalid : '')}
                      />
